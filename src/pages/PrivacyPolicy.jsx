...
const PrivacyPolicy = () => (
    <div style={{ background: "#000", color: "#ddd" }}>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or
                    "Our" in this Agreement) refers to TEDxSJEC, St Joseph Engineering College Vamanjoor Mangaluru
                    575028 Karnataka, India.</p>
            </li>
            <li>
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
            ...
            browser. Learn more about cookies: <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" rel="external nofollow noopener noreferrer" target="_blank">Cookies by PrivacyPolicies Generator</a>.</p>
